  ...
  return (
    <div className='max-w-[1640px] mx-auto flex justify-between items-center p-4'>
      ...
      <div
        className={
          nav
            ? "fixed bg-white h-screen top-0 left-0 w-[300px] z-10 duration-300"
            : "fixed bg-white h-screen top-0 left-[-100%] w-[300px] z-10 duration-300"
        }>
        <AiOutlineClose
          onClick={() => setNav(!nav)}
          size={25}
        ...
        <nav className='flex flex-col p-4 top-4 text-gray-800'>
          <ul>
